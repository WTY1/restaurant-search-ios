...
- (void)viewDidLoad {
    ...
    self.userLocation = self.userLocation ? : [[CLLocation alloc] initWithLatitude:37.3263625 longitude:-122.027210];
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"set-icon"] style:UIBarButtonItemStylePlain target:self action:@selector(didTapSettings)];
